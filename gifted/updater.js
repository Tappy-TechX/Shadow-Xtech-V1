...
gmd(
    ...
    async (from, Gifted, conText) => {
        ...
        try {
            ...
            const zipPath = path.join(__dirname, "..", "Shadow-Xtech-V1-main.zip"); // Replace this  with your bot name and branch if you're cloning
            ...
            const sourcePath = path.join(extractPath, "Shadow-Xtech-V1-main"); // Replace this  with your bot name and branch if you're cloning
