...
const DEFAULT_SETTINGS = {
    PREFIX: ".",
    OWNER_NAME: "*Tappy-TechX*",
    OWNER_NUMBER: "254756360306",
    BOT_NAME: "Shadow-Xtech-V1",
    FOOTER: "© Powered By Shadow-Xtech-V1",
    CAPTION: "© 2026 Shadow-Xtech",
    BOT_PIC: "https://files.catbox.moe/1busib.jpg",
    ...
    STATUS_REPLY_TEXT: "*Your Status Has Been Viewed Successful ✅*",
    AUTO_REACT: "off",
    AUTO_REPLY: "false",
    ...
    NEWSLETTER_JID: "120363369453603973@newsletter",
    GC_JID: "LZE4CoZNhLB28z5jtqwNLA",
    NEWSLETTER_URL: "https://whatsapp.com/channel/0029VasHgfG4tRrwjAUyTs10",
    BOT_REPO: "Tappy-TechX/Shadow-Xtech",
    PACK_NAME: "Shadow-Xtech",
    PACK_AUTHOR: "Tappy-TechX",
    SUDO_NUMBERS: "",
    PM_PERMIT: "false",
    ANTIVIEWONCE: "indm",
};
